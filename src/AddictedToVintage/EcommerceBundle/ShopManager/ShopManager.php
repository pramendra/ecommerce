...
namespace AddictedToVintage\EcommerceBundle\ShopManager;
...
use AddictedToVintage\EcommerceBundle\Entity\Cart;
use AddictedToVintage\EcommerceBundle\Entity\CartProducts;
use AddictedToVintage\EcommerceBundle\Entity\Client;
use AddictedToVintage\EcommerceBundle\Entity\Product;
use AddictedToVintage\EcommerceBundle\Entity\Shipping;
use AddictedToVintage\EcommerceBundle\Entity\ShippingTypes;
use AddictedToVintage\EcommerceBundle\Entity\Orders;
use AddictedToVintage\EcommerceBundle\Entity\OrdersProduct;
use AddictedToVintage\EcommerceBundle\Entity\Coupon;
use AddictedToVintage\EcommerceBundle\Entity\Paymethod;
