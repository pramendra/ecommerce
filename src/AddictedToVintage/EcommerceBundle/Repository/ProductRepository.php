...
use AddictedToVintage\EcommerceBundle\Entity\Subcategory;
...
//        $qb->setParameter('keyword', '%'. $keyword . '%');
    ...
    public function findLatestProductsBySection(\AddictedToVintage\EcommerceBundle\Entity\Section $section, $maxResults = 99999) { 
    ...
    public function findLatestProductsByCategory(\AddictedToVintage\EcommerceBundle\Entity\Category $category, $maxResults = 5) { 
    ...
    public function findAllProductsByCategory(\AddictedToVintage\EcommerceBundle\Entity\Category $category) { 
