...
namespace AddictedToVintage\EcommerceBundle\MultiSafePay;

use AddictedToVintage\EcommerceBundle\MultiSafePay\msp_gc_xmlparser;

define('MSP_TEST_API', true); // seperate testaccount needed
define('MSP_ACCOUNT_ID', '10099492');
define('MSP_SITE_ID', '6337');
define('MSP_SITE_CODE', '953492');
...
class MultiSafePay {
    ...
    function parseXmlResponse($response) {
        ...
        $xmlParams = array(XML_OPTION_CASE_FOLDING => 0);

        // parse
        // XML PARSE BUG: http://bugs.php.net/bug.php?id=45996
        $input = str_replace('&amp;', '[msp-amp]', $response);
        //
        ...
        $this->parsed_xml = $this->GetData();
        $this->parsed_root = $this->GetRoot();
