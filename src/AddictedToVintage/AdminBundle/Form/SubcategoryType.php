...
class SubcategoryType extends AbstractType {
    ...
    public function __construct(\AddictedToVintage\EcommerceBundle\Entity\Subcategory $subcategory) {
    ...
    public function buildForm(FormBuilderInterface $builder, array $options) {
        ...
        $builder->add('categories', 'entity', array('class' => 'AddictedToVintage\\EcommerceBundle\Entity\\Category', 'multiple' => true, 'expanded' => false,
            'query_builder' => function (\AddictedToVintage\EcommerceBundle\Repository\CategoryRepository $repository) use ($subcategory) {
