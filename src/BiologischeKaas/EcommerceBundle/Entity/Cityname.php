...
/**
 * BiologischeKaas\EcommerceBundle\Entity\Cityname
 */
class Cityname
{
    /**
     ...
     * Set city
     *
     * @param BiologischeKaas\EcommerceBundle\Entity\City $city
     */
    public function setCity(\BiologischeKaas\EcommerceBundle\Entity\City $city)
    {
        $this->city = $city;
    }
