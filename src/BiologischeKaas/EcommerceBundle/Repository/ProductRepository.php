...
use BiologischeKaas\EcommerceBundle\Entity\Subcategory;
...
//        $qb->setParameter('keyword', '%'. $keyword . '%');
    ...
    public function findLatestProductsBySection(\BiologischeKaas\EcommerceBundle\Entity\Section $section, $maxResults = 99999) { 
    ...
    public function findLatestProductsByCategory(\BiologischeKaas\EcommerceBundle\Entity\Category $category, $maxResults = 5) { 
    ...
    public function findAllProductsByCategory(\BiologischeKaas\EcommerceBundle\Entity\Category $category) { 
