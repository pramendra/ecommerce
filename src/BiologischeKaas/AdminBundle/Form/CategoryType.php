...
class CategoryType extends AbstractType {
    ...
    public function __construct(\BiologischeKaas\EcommerceBundle\Entity\Category $category) {
    ...
    public function buildForm(FormBuilderInterface $builder, array $options) {
        ...
        $builder->add('sections', 'entity', array('class' => 'AddictedToVintage\\EcommerceBundle\Entity\\Section', 'multiple' => true, 'expanded' => true,
            'query_builder' => function (\BiologischeKaas\EcommerceBundle\Repository\SectionRepository $repository) use ($category) {
