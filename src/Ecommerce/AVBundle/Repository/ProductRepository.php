...
use Ecommerce\AVBundle\Entity\Subcategory;
...
class ProductRepository extends EntityRepository {
    ...
    public function getProductAttributes($products, $attribute) {
        $query = "SELECT pa
        		FROM AVBundle:ProductAttributes pa 
...
//        $qb->setParameter('keyword', '%'. $keyword . '%');
    ...
    public function findLatestProductsBySection(\Ecommerce\AVBundle\Entity\Section $section, $maxResults = 99999) { 
    ...
    public function findLatestProductsByCategory(\Ecommerce\AVBundle\Entity\Category $category, $maxResults = 5) { 
    ...
    public function findAllProductsByCategory(\Ecommerce\AVBundle\Entity\Category $category) { 
