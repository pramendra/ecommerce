...
namespace Ecommerce\AVBundle\ProductFilter;
...
use Ecommerce\AVBundle\Entity\Attribute;
use Ecommerce\AVBundle\Entity\Subcategory;
use Ecommerce\AVBundle\Entity\Category;
use Ecommerce\AVBundle\Entity\Section;
