...
namespace Ecommerce\AVBundle\PageManager;

use Symfony\Component\DependencyInjection\ContainerAware;
use Ecommerce\AVBundle\Entity\Page;
...
class PageManager extends ContainerAware {
    ...
    public function setPermalink($permalink) {
        ...
        $page = $this->getDoctrine()->getRepository('AVBundle:Page')->findOneByPermalink($permalink);
