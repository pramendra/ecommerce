...
namespace Ecommerce\AVBundle\ShopManager;
...
use Ecommerce\AVBundle\Entity\Cart;
use Ecommerce\AVBundle\Entity\CartProducts;
use Ecommerce\AVBundle\Entity\Client;
use Ecommerce\AVBundle\Entity\Product;
use Ecommerce\AVBundle\Entity\Shipping;
use Ecommerce\AVBundle\Entity\ShippingTypes;
use Ecommerce\AVBundle\Entity\Orders;
use Ecommerce\AVBundle\Entity\OrdersProduct;
use Ecommerce\AVBundle\Entity\Coupon;
use Ecommerce\AVBundle\Entity\Paymethod;
...
class ShopManager extends ContainerAware {
    ...
    function initialize() {
        ...
        if ($this->session->get('cart') !== null) {
            ...
            if($cart->getId() !== null) {
                $this->cart = $this->getDoctrine()->getRepository('AVBundle:Cart')->find($cart->getId());
            } else { 
                $this->cart = new Cart();
        ...
        if ($this->session->get('order') !== null) {
            ...
            $this->order = $this->getDoctrine()->getRepository('AVBundle:Orders')->find($order->getId());
        } else {
            $this->order = null;
        ...
        if ($this->session->get('shipping') !== null) {
            ...
            $this->shipping = $this->getDoctrine()->getRepository('AVBundle:Shipping')->find(1);
    ...
    public function setShipping($shipping) {
        ...
        $this->shipping = $this->getDoctrine()->getRepository('AVBundle:Shipping')->find($shipping);
        $this->session->set('shipping', $this->shipping);        
    ...
    public function getShoppingList() {
        ...
        foreach ($list as $item) {
            ...
            if (!empty($item)) {
                ...
                $product = $this->getDoctrine()->getRepository('AVBundle:Product')->find($item);
    ...
    public function getCoupon() {
        ...
        if ($this->coupon->getId() !== null) {
            return $this->getDoctrine()->getRepository('AVBundle:Coupon')->find($this->coupon->getId());
        } else { 
            return null;
        }
    ...
    public function removeProductFromCart(Product $product) { 
        ...
        $cartProduct = $this->getDoctrine()
                ->getRepository('AVBundle:CartProducts')
        ...
        if ($containsPackage) {
            ...
            $shipping = $this->getDoctrine()
                            ->getRepository('AVBundle:Shipping')->findOneBy(array('shippingType' => 1, 'active' => 1));
            
        } else {
            /* Fetch active shipping methods */
            $shipping = $this->getDoctrine()
                            ->getRepository('AVBundle:Shipping')->findOneBy(array('shippingType' => 2, 'active' => 1));
        }
    ...
    public function addCouponCode($code) {
        ...
        $this->coupon = $this->getDoctrine()->getRepository('AVBundle:Coupon')->findOneBy(array('code' => $code));
    ...
    public function setPaymethod($request) { 
        ...
        $paymethod = $this->getDoctrine()->getRepository('AVBundle:Paymethod')->findOneBy(array('code' => $payment[0]));
    ...
    public function createOrder($request) {
        ...
        // get entity manager
        $em = $this->getDoctrine()->getEntityManager();
        $this->client = $this->getDoctrine()->getRepository('AVBundle:Client')->find($this->client->getId());
        $this->shipping = $this->getDoctrine()->getRepository('AVBundle:Shipping')->find($this->shipping->getId());
        $this->paymethod = $this->getDoctrine()->getRepository('AVBundle:Paymethod')->find($this->paymethod->getId());
        ...
        if ($this->order == null) {
            ...
            if($this->coupon->getId() != null) { 
                ...
                $coupon = $this->getDoctrine()->getRepository('AVBundle:Coupon')->find($this->coupon->getId());
            ...
            // Fetch new orderNr
            $orderNr = $this->getDoctrine()->getRepository('AVBundle:Orders')->getNewOrderNr();
    ...
    private function createCart() {
        ...
        $this->shipping = $this->getDoctrine()
                ->getRepository('AVBundle:Shipping')
    ...
    private function updateCart() {
        ...
        $cart = $this->getDoctrine()->getRepository('AVBundle:Cart')->findOneBy(array('id' => $this->cart->getId()));
