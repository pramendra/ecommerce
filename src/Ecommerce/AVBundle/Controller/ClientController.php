...
class ClientController extends Controller {
    ...
    public function indexAction() {
        ...
        $TotalOrdersPrice = $this->getDoctrine()->getRepository('AVBundle:Orders')->getTotalOrdersPrice($client);
        
        return $this->render('AVBundle:Client:index.html.twig', array(
    ...
    public function loginAction() {
        ...
        return $this->render('AVBundle:Security:login.html.twig', array(
    ...
    public function addressLookupAction() {
        ...
        if ($this->getRequest()->getMethod() === 'POST') {
            ...
            $postcode_repository = $this->getDoctrine()->getRepository('AVBundle:Postcode');
