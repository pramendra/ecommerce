...
use Ecommerce\AVBundle\ProductFilter\ProductFilter;
...
class AjaxController extends Controller {
    ...
    private function remove_from_cart() {
        ...
        $product = $this->getDoctrine()->getRepository('AVBundle:Product')->find($this->getRequest()->get('product'));
    ...
    private function add_to_cart() {
        ...
        $product = $this->getDoctrine()
                ->getRepository('AVBundle:Product')
    ...
    private function set_product_filter() {
        ...
        $attribute = $this->getDoctrine()->getRepository('AVBundle:Attribute')->find($attribute_id);
