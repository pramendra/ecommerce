...
class ProductController extends Controller {
    ...
    public function viewAction($section, $category, $subcategory, $product) {
        ...
        $subcategories_repository = $this->getDoctrine()->getRepository('AVBundle:Subcategory');
...
//        
//        if($attribute != null) { 
//            $related_products = $this->getDoctrine()->getRepository('AVBundle:Product')->findRelatedProductsByAttribute($subcategory, $attribute, 4, $product);
//        }
//        
        if($related_products == null) { 
            $related_products = $this->getDoctrine()->getRepository('AVBundle:Product')->getActiveProductsBySubcategory($subcategory, 4);
        }
        ...
        */
        ...
        return $this->render('AVBundle:Product:index.html.twig', array('sale_discount' => $sale_discount, 'product' => $product, 'category' => $category, 'section' => $section, 'subcategory' => $subcategory, 'page' => $page, 'sections' => $sections, 'related_products' => $related_products, 'show_canonical' => $show_canonical  ));
    }
