...
namespace Ecommerce\AddictedtovintageBundle\PageManager;

use Symfony\Component\DependencyInjection\ContainerAware;
use Ecommerce\AddictedtovintageBundle\Entity\Page;
...
class PageManager extends ContainerAware {
    ...
    public function setPermalink($permalink) {
        ...
        $page = $this->getDoctrine()->getRepository('AddictedtovintageBundle:Page')->findOneByPermalink($permalink);
