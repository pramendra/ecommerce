...
/**
 * Ecommerce\AddictedtovintageBundle\Entity\Cityname
 */
class Cityname
{
    /**
     ...
     * Set city
     *
     * @param Ecommerce\AddictedtovintageBundle\Entity\City $city
     */
    public function setCity(\Ecommerce\AddictedtovintageBundle\Entity\City $city)
    {
        $this->city = $city;
    }
