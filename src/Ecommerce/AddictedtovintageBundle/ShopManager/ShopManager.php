...
namespace Ecommerce\AddictedtovintageBundle\ShopManager;
...
use Ecommerce\AddictedtovintageBundle\Entity\Cart;
use Ecommerce\AddictedtovintageBundle\Entity\CartProducts;
use Ecommerce\AddictedtovintageBundle\Entity\Client;
use Ecommerce\AddictedtovintageBundle\Entity\Product;
use Ecommerce\AddictedtovintageBundle\Entity\Shipping;
use Ecommerce\AddictedtovintageBundle\Entity\ShippingTypes;
use Ecommerce\AddictedtovintageBundle\Entity\Orders;
use Ecommerce\AddictedtovintageBundle\Entity\OrdersProduct;
use Ecommerce\AddictedtovintageBundle\Entity\Coupon;
use Ecommerce\AddictedtovintageBundle\Entity\Paymethod;
...
class ShopManager extends ContainerAware {
    ...
    function initialize() {
        ...
        if ($this->session->get('cart') !== null) {
            ...
            if($cart->getId() !== null) {
                $this->cart = $this->getDoctrine()->getRepository('AddictedtovintageBundle:Cart')->find($cart->getId());
            } else { 
                $this->cart = new Cart();
        ...
        if ($this->session->get('order') !== null) {
            ...
            $this->order = $this->getDoctrine()->getRepository('AddictedtovintageBundle:Orders')->find($order->getId());
        } else {
            $this->order = null;
        ...
        if ($this->session->get('shipping') !== null) {
            ...
            $this->shipping = $this->getDoctrine()->getRepository('AddictedtovintageBundle:Shipping')->find(1);
    ...
    public function setShipping($shipping) {
        ...
        $this->shipping = $this->getDoctrine()->getRepository('AddictedtovintageBundle:Shipping')->find($shipping);
        $this->session->set('shipping', $this->shipping);        
    ...
    public function getShoppingList() {
        ...
        foreach ($list as $item) {
            ...
            if (!empty($item)) {
                ...
                $product = $this->getDoctrine()->getRepository('AddictedtovintageBundle:Product')->find($item);
    ...
    public function getCoupon() {
        ...
        if ($this->coupon->getId() !== null) {
            return $this->getDoctrine()->getRepository('AddictedtovintageBundle:Coupon')->find($this->coupon->getId());
        } else { 
            return null;
        }
    ...
    public function removeProductFromCart(Product $product) { 
        ...
        $this->cart = $this->getDoctrine()
                ->getRepository('AddictedtovintageBundle:Cart')
        ...
        $cartProduct = $this->getDoctrine()
                ->getRepository('AddictedtovintageBundle:CartProducts')
        ...
        if ($containsPackage) {
            ...
            $shipping = $this->getDoctrine()
                            ->getRepository('AddictedtovintageBundle:Shipping')->findOneBy(array('shippingType' => 1, 'active' => 1));
            
        } else {
            /* Fetch active shipping methods */
            $shipping = $this->getDoctrine()
                            ->getRepository('AddictedtovintageBundle:Shipping')->findOneBy(array('shippingType' => 2, 'active' => 1));
        }
    ...
    public function addCouponCode($code) {
        ...
        $this->coupon = $this->getDoctrine()->getRepository('AddictedtovintageBundle:Coupon')->findOneBy(array('code' => $code));
    ...
    public function setPaymethod($request) { 
        ...
        $paymethod = $this->getDoctrine()->getRepository('AddictedtovintageBundle:Paymethod')->findOneBy(array('code' => $payment[0]));
    ...
    public function createOrder($request) {
        ...
        // get entity manager
        $em = $this->getDoctrine()->getEntityManager();
        $this->client = $this->getDoctrine()->getRepository('AddictedtovintageBundle:Client')->find($this->client->getId());
        $this->shipping = $this->getDoctrine()->getRepository('AddictedtovintageBundle:Shipping')->find($this->shipping->getId());
        $this->paymethod = $this->getDoctrine()->getRepository('AddictedtovintageBundle:Paymethod')->find($this->paymethod->getId());
        ...
        if ($this->order == null) {
            ...
            if($this->coupon->getId() != null) { 
                ...
                $coupon = $this->getDoctrine()->getRepository('AddictedtovintageBundle:Coupon')->find($this->coupon->getId());
            ...
            // Fetch new orderNr
            $orderNr = $this->getDoctrine()->getRepository('AddictedtovintageBundle:Orders')->getNewOrderNr();
    ...
    private function createCart() {
        ...
        $this->shipping = $this->getDoctrine()
                ->getRepository('AddictedtovintageBundle:Shipping')
    ...
    private function updateCart() {
        ...
        $cart = $this->getDoctrine()->getRepository('AddictedtovintageBundle:Cart')->findOneBy(array('id' => $this->cart->getId()));
