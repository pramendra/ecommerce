...
class CategoryController extends Controller {
    ...
    public function indexAction($section, $category) {
        ...
        if($category == null) { 
            return $this->forward('AddictedtovintageBundle:Product:shortcut', array('product' => $category_permalink));
        }
        ...
        $page = $this->getDoctrine()->getRepository('AddictedtovintageBundle:Page')->findOneBy(array('permalink' => $section_permalink .'/'.$category_permalink));
        ...
        if($productFilter->getAttributes() !== null) { 
            ...
            $active_products = $this->getDoctrine()->getRepository('AddictedtovintageBundle:Product')->findAllProductsByCategory($category);
        ...
        return $this->render('AddictedtovintageBundle:Category:index.html.twig', array(
    ...
    public function subcategoryAction($section, $category, $subcategory) {
        ...
        if($productFilter->getAttributes() !== null) { 
            ...
            $active_products = $this->getDoctrine()->getRepository('AddictedtovintageBundle:Product')->getActiveProductsBySubcategory($subcategory);
        ...
        */
        ...
        return $this->render('AddictedtovintageBundle:Subcategory:index.html.twig', array(
                    'products' => $products,
                    'page' => $page,
