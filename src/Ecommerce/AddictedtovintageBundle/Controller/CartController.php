...
use Ecommerce\AddictedtovintageBundle\MultiSafePay\MultiSafePay;
...
class CartController extends Controller {
    ...
    public function MSPPaymentPageAction() {
        ...
        return $this->render('AddictedtovintageBundle:MSP:betalen.html.twig', array('test' => $test));
    }
    ...
    public function indexAction() {
        ...
        $shippings = $this->getDoctrine()->getRepository('AddictedtovintageBundle:Shipping')->findBy(array('shippingType' => $shippingType, 'active' => 1));
        
        return $this->render('AddictedtovintageBundle:Cart:index.html.twig', array('cart' => $cart, 'discount' => $discount, 'shippings' => $shippings, 'coupon' => $coupon));
    }
    ...
    public function shippingAction() {
        ...
        /* Fetch active shipping methods */
        $shippings = $this->getDoctrine()->getRepository('AddictedtovintageBundle:Shipping')->findBy(array('shippingType' => $cart->getShipping()->getShippingType(), 'active' => 1));

        $next_delivery_date = $this->getNextDeliveryDate();
        
        $next_delivery_date_range = $this->getNextDeliveryDateRange();
        
        return $this->render('AddictedtovintageBundle:Checkout:shipping.html.twig', array('cart' => $cart, 'next_delivery_date' => $next_delivery_date, 'client' => $client, 'shippings' => $shippings, 'next_delivery_date_range' => $next_delivery_date_range));
    }
    ...
    public function paymentAction() {
        ...
        $paymethods = $this->getDoctrine()->getRepository('AddictedtovintageBundle:Paymethod')->findBy(array('isActive' => 1));
        ...
        return $this->render('AddictedtovintageBundle:Checkout:payment.html.twig', array('cart' => $cart, 'paymethods' => $paymethods, 'discount' => $discount));
    }
    ...
    public function overviewAction() {
        ...
        return $this->render('AddictedtovintageBundle:Checkout:overview.html.twig', array('cart' => $cart, 'next_delivery_date' => $next_delivery_date, 'client' => $client, 'discount' => $discount, 'paymethod' => $paymethod));
    }
    ...
    public function checkoutAction() {
        ...
        if ($this->getRequest()->getMethod() === 'POST') {
            ...
            $message = \Swift_Message::newInstance()
                    ...
                    ->addPart($this->renderView('AddictedtovintageBundle:Email:order.txt.twig', array('order' => $order, 'products' => $products, 'client' => $client)))
                    ->setBody($this->renderView('AddictedtovintageBundle:Email:order.html.twig', array('order' => $order, 'products' => $products, 'client' => $client)), 'text/html')
            ;
            ...
            $client = $this->getDoctrine()->getRepository('AddictedtovintageBundle:Client')->find($client);
            
            $email = new \Ecommerce\AddictedtovintageBundle\Entity\Email();
            $email->setClient($client);
            $email->setContent($this->renderView('AddictedtovintageBundle:Email:order.html.twig', array('order' => $order, 'products' => $products, 'client' => $client)));
        ...
        return $this->render('AddictedtovintageBundle:Checkout:index.html.twig', array('cart' => $cart));
    }

    public function checkoutCompleteAction() {

        $order = $this->getDoctrine()->getRepository('AddictedtovintageBundle:Orders')->findOneBy(array('ordernr' => $this->getRequest()->get('transactionid')));
        ...
        return $this->render('AddictedtovintageBundle:Checkout:success.html.twig', array('order' => $order));
    }
    ...
    public function checkoutCancelAction() {
        ...
        return $this->render('AddictedtovintageBundle:Checkout:cancel.html.twig', array('order' => $order));
    }
	...
	if($this->get('kernel')->getEnvironment() == 'dev') { 
        ...
        $order = $this->getDoctrine()->getRepository('AddictedtovintageBundle:Orders')->findOneBy(array('ordernr' => $transactionid));
