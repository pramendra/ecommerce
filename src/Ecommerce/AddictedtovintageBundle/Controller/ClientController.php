...
class ClientController extends Controller {
    ...
    public function indexAction() {
        ...
        $TotalOrdersPrice = $this->getDoctrine()->getRepository('AddictedtovintageBundle:Orders')->getTotalOrdersPrice($client);
        
        return $this->render('AddictedtovintageBundle:Client:index.html.twig', array(
    ...
    public function loginAction() {
        ...
        return $this->render('AddictedtovintageBundle:Security:login.html.twig', array(
    ...
    public function addressLookupAction() {
        ...
        if ($this->getRequest()->getMethod() === 'POST') {
            ...
            $postcode_repository = $this->getDoctrine()->getRepository('AddictedtovintageBundle:Postcode');
