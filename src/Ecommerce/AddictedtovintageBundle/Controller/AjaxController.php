...
use Ecommerce\AddictedtovintageBundle\ProductFilter\ProductFilter;
...
class AjaxController extends Controller {
    ...
    private function remove_from_cart() {
        ...
        $product = $this->getDoctrine()->getRepository('AddictedtovintageBundle:Product')->find($this->getRequest()->get('product'));
    ...
    private function add_to_cart() {
        ...
        $product = $this->getDoctrine()
                ->getRepository('AddictedtovintageBundle:Product')
    ...
    private function set_product_filter() {
        ...
        $attribute = $this->getDoctrine()->getRepository('AddictedtovintageBundle:Attribute')->find($attribute_id);
