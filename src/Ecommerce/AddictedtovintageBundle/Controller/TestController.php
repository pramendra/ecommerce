...
//        $val3 = 'groen';
        ...
        $product_attributes = $this->getDoctrine()->getRepository('AddictedtovintageBundle:ProductAttributes')->findbyAttributeLike($search);
        ...
        foreach($product_attributes as $pa) { 
            ...
            $attribute = $this->getDoctrine()->getRepository('AddictedtovintageBundle:Attribute')->find($pa->getAttribute()->getId());
            $product = $this->getDoctrine()->getRepository('AddictedtovintageBundle:Product')->find($pa->getProduct()->getId());
...
//            $em->persist($new_pa2);
    ...
    public function emailAction() { 
        ...
        $order = $this->getDoctrine()->getRepository('AddictedtovintageBundle:Orders')->find(22);
        
        return $this->render('AddictedtovintageBundle:Email:order.html.twig', array('order' => $order));
