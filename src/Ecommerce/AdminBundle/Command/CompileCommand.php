...
class CompileCommand extends ContainerAwareCommand {
    ...
    protected function execute(InputInterface $input, OutputInterface $output) {
        ...
        try {
            $less = new lessc(__DIR__ . '/../../BiologischekaasBundle/Resources/public/less/app.less');
        } catch (exception $ex) {
        ...
        $this->output->writeln('Writing file: BiologischekaasBundle/Resources/public/css/app-min.css');

        file_put_contents(__DIR__ . '/../../BiologischekaasBundle/Resources/public/css/app-min.css', $this->css_cmpress($less->parse()));
        ...
        foreach ($files as $file) {
            ...
            $src = '' . __DIR__ . '/../../BiologischekaasBundle/Resources/public/js/' . $file . '.js';
            $out = '' . __DIR__ . '/../../BiologischekaasBundle/Resources/public/js/' . $file . '-min.js';
