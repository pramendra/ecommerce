...
class ProductType extends AbstractType {
    ...
    public function __construct(\Ecommerce\EcommerceBundle\Entity\Product $product) {
    ...
    public function buildForm(FormBuilderInterface $builder, array $options) {
        ...
        $builder->add('subcategories', 'entity', array('class' => 'AddictedToVintage\\EcommerceBundle\Entity\\Subcategory', 'multiple' => true, 'expanded' => true,
            'query_builder' => function (\Ecommerce\EcommerceBundle\Repository\SubcategoryRepository $repository) use ($product) {
        ...
        $builder->add('shippingType', 'entity', array('class' => 'AddictedToVintage\\EcommerceBundle\Entity\\ShippingTypes', 'multiple' => false, 'expanded' => false, 'label' => 'Verzendwijze',
            'query_builder' => function (\Ecommerce\EcommerceBundle\Repository\ShippingTypesRepository $repository) use ($product) {
