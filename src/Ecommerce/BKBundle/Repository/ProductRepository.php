...
use Ecommerce\BKBundle\Entity\ProductAttributes;

class ProductRepository extends EntityRepository {

    public function getProductAttributes($products, $attribute) {
        $query = "SELECT pa
        		FROM BKBundle:ProductAttributes pa 
...
//        $qb->setParameter('keyword', '%'. $keyword . '%');
    ...
    public function findLatestProductsBySection(\Ecommerce\BKBundle\Entity\Section $section, $maxResults = 99999) { 
    ...
    public function findLatestProductsByCategory(\Ecommerce\BKBundle\Entity\Category $category, $maxResults = 5) { 
    ...
    public function findAllProductsByCategory(\Ecommerce\BKBundle\Entity\Category $category) { 
