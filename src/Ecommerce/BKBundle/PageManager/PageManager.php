...
namespace Ecommerce\BKBundle\PageManager;

use Symfony\Component\DependencyInjection\ContainerAware;
use Ecommerce\BKBundle\Entity\Page;
...
class PageManager extends ContainerAware {
    ...
    public function setPermalink($permalink) {
        ...
        $page = $this->getDoctrine()->getRepository('BKBundle:Page')->findOneByPermalink($permalink);
