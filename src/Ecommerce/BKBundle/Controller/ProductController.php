...
//        
        ...
        */
        ...
        return $this->render('BKBundle:Product:index.html.twig', array('sale_discount' => $sale_discount, 'product' => $product, 'category' => $category, 'section' => $section, 'subcategory' => $subcategory, 'page' => $page, 'sections' => $sections, 'related_products' => $related_products, 'show_canonical' => $show_canonical  ));
    }
