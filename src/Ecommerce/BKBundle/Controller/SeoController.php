...
class SeoController extends Controller {
	...
	if($page == null) {
        ...
        $section = $this->getDoctrine()->getRepository('BKBundle:Section')->find($exp[0]);
        $keyword = $exp[1];
        
        $products = $this->getDoctrine()->getRepository('BKBundle:Product')->findProductsBySectionAndKeyword($section, $keyword);
