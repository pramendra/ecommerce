...
namespace Ecommerce\BKBundle\ShopManager;
...
use Ecommerce\BKBundle\Entity\Client;
use Ecommerce\BKBundle\Entity\Product;
use Ecommerce\BKBundle\Entity\Shipping;
use Ecommerce\BKBundle\Entity\ShippingTypes;
use Ecommerce\BKBundle\Entity\Orders;
use Ecommerce\BKBundle\Entity\OrdersProduct;
use Ecommerce\BKBundle\Entity\Coupon;
use Ecommerce\BKBundle\Entity\Paymethod;
...
class ShopManager extends ContainerAware {
    ...
    function initialize() {
        ...
        if ($this->session->get('cart') !== null) {
            ...
            if($cart->getId() !== null) {
                $this->cart = $this->getDoctrine()->getRepository('BKBundle:Cart')->find($cart->getId());
            } else { 
                $this->cart = new Cart();
        ...
        if ($this->session->get('order') !== null) {
            ...
            $this->order = $this->getDoctrine()->getRepository('BKBundle:Orders')->find($order->getId());
        } else {
            $this->order = null;
        ...
        if ($this->session->get('shipping') !== null) {
            ...
            $this->shipping = $this->getDoctrine()->getRepository('BKBundle:Shipping')->find(1);
    ...
    public function setShipping($shipping) {
        ...
        $this->shipping = $this->getDoctrine()->getRepository('BKBundle:Shipping')->find($shipping);
        $this->session->set('shipping', $this->shipping);        
    ...
    public function getShoppingList() {
        ...
        foreach ($list as $item) {
            ...
            if (!empty($item)) {
                ...
                $product = $this->getDoctrine()->getRepository('BKBundle:Product')->find($item);
    ...
    public function getCoupon() {
        ...
        if ($this->coupon->getId() !== null) {
            return $this->getDoctrine()->getRepository('BKBundle:Coupon')->find($this->coupon->getId());
        } else { 
            return null;
        }
    ...
    public function removeProductFromCart(Product $product) { 
        ...
        $cartProduct = $this->getDoctrine()
                ->getRepository('BKBundle:CartProducts')
        ...
        if ($containsPackage) {
            ...
            $shipping = $this->getDoctrine()
                            ->getRepository('BKBundle:Shipping')->findOneBy(array('shippingType' => 1, 'active' => 1));
            
        } else {
            /* Fetch active shipping methods */
            $shipping = $this->getDoctrine()
                            ->getRepository('BKBundle:Shipping')->findOneBy(array('shippingType' => 2, 'active' => 1));
        }
    ...
    public function addCouponCode($code) {
        ...
        $this->coupon = $this->getDoctrine()->getRepository('BKBundle:Coupon')->findOneBy(array('code' => $code));
    ...
    public function setPaymethod($request) { 
        ...
        $paymethod = $this->getDoctrine()->getRepository('BKBundle:Paymethod')->findOneBy(array('code' => $payment[0]));
    ...
    public function createOrder($request) {
        ...
        // get entity manager
        $em = $this->getDoctrine()->getEntityManager();
        $this->client = $this->getDoctrine()->getRepository('BKBundle:Client')->find($this->client->getId());
        $this->shipping = $this->getDoctrine()->getRepository('BKBundle:Shipping')->find($this->shipping->getId());
        $this->paymethod = $this->getDoctrine()->getRepository('BKBundle:Paymethod')->find($this->paymethod->getId());
        ...
        if ($this->order == null) {
            ...
            if($this->coupon->getId() != null) { 
                ...
                $coupon = $this->getDoctrine()->getRepository('BKBundle:Coupon')->find($this->coupon->getId());
            ...
            // Fetch new orderNr
            $orderNr = $this->getDoctrine()->getRepository('BKBundle:Orders')->getNewOrderNr();
    ...
    private function createCart() {
        ...
        $this->shipping = $this->getDoctrine()
                ->getRepository('BKBundle:Shipping')
    ...
    private function updateCart() {
        ...
        $cart = $this->getDoctrine()->getRepository('BKBundle:Cart')->findOneBy(array('id' => $this->cart->getId()));
