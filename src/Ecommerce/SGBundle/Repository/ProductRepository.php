...
use Ecommerce\SGBundle\Entity\Subcategory;
...
class ProductRepository extends EntityRepository {
    ...
    public function getProductAttributes($products, $attribute) {
        $query = "SELECT pa
        		FROM SGBundle:ProductAttributes pa 
...
//        $qb->setParameter('keyword', '%'. $keyword . '%');
    ...
    public function findLatestProductsBySection(\Ecommerce\SGBundle\Entity\Section $section, $maxResults = 99999) { 
    ...
    public function findLatestProductsByCategory(\Ecommerce\SGBundle\Entity\Category $category, $maxResults = 5) { 
    ...
    public function findAllProductsByCategory(\Ecommerce\SGBundle\Entity\Category $category) { 
