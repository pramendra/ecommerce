...
namespace Ecommerce\SGBundle\ProductFilter;
...
use Ecommerce\SGBundle\Entity\Attribute;
use Ecommerce\SGBundle\Entity\Subcategory;
use Ecommerce\SGBundle\Entity\Category;
use Ecommerce\SGBundle\Entity\Section;
