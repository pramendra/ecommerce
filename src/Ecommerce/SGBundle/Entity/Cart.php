...
class Cart {
    ...
    /**
     * @var Ecommerce\SGBundle\Entity\CartProducts
     */
    protected $products;
     ...
     * Add product
     *
     * @param Ecommerce\SGBundle\Entity\CartProducts $product
     */
    public function addProduct(\Ecommerce\SGBundle\Entity\CartProducts $product) {
