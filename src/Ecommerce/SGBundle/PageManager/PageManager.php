...
namespace Ecommerce\SGBundle\PageManager;

use Symfony\Component\DependencyInjection\ContainerAware;
use Ecommerce\SGBundle\Entity\Page;
...
class PageManager extends ContainerAware {
    ...
    public function setPermalink($permalink) {
        ...
        $page = $this->getDoctrine()->getRepository('SGBundle:Page')->findOneByPermalink($permalink);
