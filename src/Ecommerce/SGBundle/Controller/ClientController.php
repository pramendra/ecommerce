...
class ClientController extends Controller {
    ...
    public function indexAction() {
        ...
        $TotalOrdersPrice = $this->getDoctrine()->getRepository('SGBundle:Orders')->getTotalOrdersPrice($client);
        
        return $this->render('SGBundle:Client:index.html.twig', array(
    ...
    public function loginAction() {
        ...
        return $this->render('SGBundle:Security:login.html.twig', array(
    ...
    public function addressLookupAction() {
        ...
        if ($this->getRequest()->getMethod() === 'POST') {
            ...
            $postcode_repository = $this->getDoctrine()->getRepository('SGBundle:Postcode');
