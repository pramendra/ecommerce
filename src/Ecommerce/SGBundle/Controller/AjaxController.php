...
use Ecommerce\SGBundle\ProductFilter\ProductFilter;
...
class AjaxController extends Controller {
    ...
    private function remove_from_cart() {
        ...
        $product = $this->getDoctrine()->getRepository('SGBundle:Product')->find($this->getRequest()->get('product'));
    ...
    private function add_to_cart() {
        ...
        $product = $this->getDoctrine()
                ->getRepository('SGBundle:Product')
    ...
    private function set_product_filter() {
        ...
        $attribute = $this->getDoctrine()->getRepository('SGBundle:Attribute')->find($attribute_id);
