    ...
    public function indexAction() {
        ...
        if ($this->getRequest()->getMethod() === 'POST') {
            ...
            if($q !== null) { 
                ...
                $products_repository = $this->getDoctrine()->getRepository('SGBundle:Product');
        ...
        return $this->render('SGBundle:Search:index.html.twig', array('products' => $products));
    }
